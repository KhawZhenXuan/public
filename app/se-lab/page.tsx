...
export const metadata: Metadata = {
  title: "S&E LAB — Vocal Removal & Audio Separation",
    ...
    <main className="sePage">
      <nav className="nav" aria-label="S&E LAB navigation">
        ...
        <div className="navLinks">
          <a href="/">DrunKitten</a><a href="/production">Production</a><a href="https://darrenk.drunkitten.xyz">Darren</a><ThemeToggle /><a className="languageSwitch" href="/zh/se-lab" lang="zh-CN">中文</a>
        </div>
      </nav>
      ...
      <section className="seHero" id="top">
        ...
        <div className="seHeroCard">
          ...
          <img src="/s-and-e-lab-logo.png" alt="S&E LAB — Sound & Edit" />
        </div>
      </section>

      <section className="seServices section" id="services">
        <div className="sectionIntro"><p className="kicker">01 · Services</p><h2>Separate the mix.<br />Keep the possibilities.</h2></div>
        <div className="seServiceGrid">
          ...
          <article className="seServiceNote"><span className="seServiceIcon">↗</span><small>03</small><h3>Online delivery</h3><p>Send the song digitally and receive the separated result online—simple, focused, and made for individual projects.</p><span className="seTag">Available now</span></article>
        </div>
      </section>

      <section className="seProcess section" id="process">
        <div className="seProcessCopy"><p className="kicker">02 · The process</p><h2>From one track<br />to two new paths.</h2><p>S&amp;E LAB takes a finished song and separates its main vocal content from the music underneath.</p></div>
      ...
      <section className="seUseCases section">
        <p className="kicker">03 · Made for</p>
      ...
      <section className="seAbout section" id="about-lab">
        ...
        <div><p className="kicker">04 · Part of the family</p><h2>Built inside DrunKitten.</h2><p>S&amp;E LAB is the active audio-service branch of DrunKitten, created and operated by Darren Khaw.</p><a className="button secondary" href="/">Meet DrunKitten <Arrow /></a></div>
      </section>

      <footer className="seFooter"><div className="seFooterIdentity"><a className="seFooterBrand" href="/se-lab" aria-label="S&E LAB home"><img src="/s-and-e-lab-mark.png" alt=""/><SELabWordmark /></a><a className="seFooterBy" href="/" aria-label="DrunKitten home"><span>by</span><DrunKittenWordmark /></a></div><div className="brandFooterCopy"><p>Sound &amp; Editing LAB · Online audio services</p><nav className="brandContactLinks" aria-label="Contact S&E LAB"><a href="mailto:darrenkhaw@drunkitten.xyz">Email</a><a href="https://discord.gg/QxKMNTXUke" target="_blank" rel="noreferrer">Discord ↗</a></nav></div><a href="#top">Back to top ↑</a><small>© {new Date().getFullYear()} Darren Khaw · Independent creative project</small></footer>
    </main>
  );
}
