...
return <main className="darrenPage" lang="zh-CN">
  ...
  <section className="darrenRoles section" id="roles"><div className="sectionIntro"><p className="kicker">03 Â· åˆ›æ„é¡¹ç›®</p><h2>èˆžå°ä¹‹å¤–ã€‚</h2></div><div className="roleGrid"><article><span>åˆ›æ„å“ç‰Œ</span><h3>DrunKitten</h3><p>æ±‡é›†æˆ‘æ‰€æœ‰åˆ›ä½œçš„ä¸»å“ç‰Œä¸Žåˆ›æ„ç©ºé—´ã€‚</p></article><article><span>çº¿ä¸ŠæœåŠ¡</span><h3>S&amp;E LAB</h3><p>æˆ‘æä¾›äººå£°ç§»é™¤ä¸ŽéŸ³é¢‘åˆ†ç¦»çš„çŽ°æœ‰æœåŠ¡ã€‚</p></article><article><span>å‘å±•ä¸­çš„éŸ³ä¹é¡¹ç›®</span><h3>DrunKitten Production</h3><p>éšç€æˆ‘ç»§ç»­å­¦ä¹ éŸ³ä¹åˆ¶ä½œï¼Œä¸ºæœªæ¥åŽŸåˆ›éŸ³ä¹å»ºç«‹çš„ç©ºé—´ã€‚</p></article></div></section>

  <section className="darrenCredits section"><DarrenLogo/><div><p className="kicker">04 Â· æœªæ¥ç½²åæ–¹å¼</p><div className="darrenCreditRows"><p><span>æ¼”å”±</span><strong>Darren Khaw</strong></p><p><span>åˆ¶ä½œ</span><strong>DrunKitten Production &amp; Darren Khaw</strong></p></div></div></section>

  <section className="darrenContact section" id="contact"><div className="contactIntro"><p className="kicker">05 Â· è”ç³»æ–¹å¼</p><h2>ä¸Žæˆ‘è”ç³»</h2><p>æ‚¨å¯ä»¥ç›´æŽ¥è”ç³»æˆ‘ï¼Œæˆ–é€šè¿‡ç¤¾äº¤åª’ä½“ä¸Žæˆ‘äº¤æµã€‚</p></div><div className="contactGrid"><a href="mailto:darrenkhaw@drunkitten.com"><span>ç”µå­é‚®ä»¶</span><strong>darrenkhaw@drunkitten.com</strong><i>â†—</i></a><a href="https://wa.me/601111909196" target="_blank" rel="noreferrer"><span>WhatsApp</span><strong>å‘é€ä¿¡æ¯</strong><i>â†—</i></a><a href="https://www.instagram.com/darrenkhaw0920/" target="_blank" rel="noreferrer"><span>Instagram</span><strong>@darrenkhaw0920</strong><i>â†—</i></a><a href="https://www.facebook.com/darren.khaw.2025" target="_blank" rel="noreferrer"><span>Facebook</span><strong>Darren Khaw</strong><i>â†—</i></a></div></section>

  <footer className="darrenFooter standaloneFooter"><a href="#top"><DarrenLogo/></a><nav className="darrenSiteLinks" aria-label="DrunKitten ç½‘ç«™ç½‘ç»œ"><a href="https://drunkitten.com/zh">DrunKitten</a><a href="https://drunkitten.com/zh/se-lab">S&amp;E LAB</a><a href="https://drunkitten.com/zh/production">éŸ³ä¹åˆ¶ä½œ</a></nav><a href="#top">è¿”å›žé¡¶éƒ¨ â†‘</a><small>Â© {new Date().getFullYear()} Darren Khaw Â· å­¦ç”Ÿ</small></footer>
</main>}
