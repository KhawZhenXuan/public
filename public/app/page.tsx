    ...
    <main>
      <nav className="nav" aria-label="Main navigation">
        ...
        <div className="navLinks">
          ...
          <a href="https://darrenk.drunkitten.com">Darren</a>
          <ThemeToggle />
          <a className="languageSwitch" href="/zh" lang="zh-CN">ä¸­æ–‡</a>
        </div>
      </nav>
      ...
      <section className="hero" id="top">
        ...
        <div className="heroContent">
          <p className="eyebrow"><span /> Independent creative studio Â· by Darren Khaw</p>
      ...
      <section className="family section" id="family">
        <div className="sectionIntro"><p className="kicker">01 Â· The family</p><h2>One identity.<br />Two creative branches.</h2></div>
        <div className="tree">
      ...
      <section className="services section" id="services">
        <div className="servicesCopy">
          <img className="seServiceLogo" src="/s-and-e-lab-logo.png" alt="S&E LAB â€” Sound & Editing" />
          <p className="kicker">02 Â· S&amp;E LAB</p><h2>Make space<br />for the sound<br /><em>you need.</em></h2>
        ...
        <div className="beforeAfter" aria-label="Vocal removal illustration">
          <div className="panelHeader"><span className="panelDots"><i/><i/><i/></span><small>S&amp;E LAB Â· AUDIO SEPARATOR</small></div>
          ...
          <div className="process"><span>Separate</span><i>â†“</i></div>
      ...
      <section className="production section">
        ...
        <div className="prodCopy">
          <p className="kicker">03 Â· What&apos;s next</p><span className="comingPill">Coming soon</span>
          <h2>Learning in public.<br />Producing with purpose.</h2>
          <p>DrunKitten Production is the next chapterâ€”a space for original music as Darren grows as a vocalist and producer.</p>
      ...
      <section className="about section" id="about">
        <div className="profileCard"><div className="profileBanner"/><img className="profilePhoto" src="/darren-khaw-profile.png" alt="Darren Khaw singing"/><span className="onlineDot"/><ThemeWord person className="darrenSignature" /><small>Owner Â· Creator Â· Learning Producer</small><p>Building useful audio services today and the music of tomorrow.</p></div>
        <div className="aboutCopy"><p className="kicker">04 Â· Behind the name</p><h2>Hi, I&apos;m Darren.</h2><p className="lead">I&apos;m the person behind DrunKittenâ€”building useful audio services today while learning to produce the music of tomorrow.</p><a className="button secondary profileLink" href="https://darrenk.drunkitten.com">Meet Darren Khaw <Arrow /></a></div>
      </section>

      <footer>
        <a className="footerBrand brandLockup" href="#top" aria-label="DrunKitten home"><ThemeLogo /><ThemeWord /></a>
        <div className="brandFooterCopy"><p>Audio services &amp; music in the making.</p><nav className="brandContactLinks" aria-label="Contact DrunKitten"><a href="mailto:darrenkhaw@drunkitten.com">Email</a><a href="https://discord.gg/QxKMNTXUke" target="_blank" rel="noreferrer">Discord â†—</a></nav></div><a href="#top">Back to top â†‘</a>
        <small>Â© {new Date().getFullYear()} Darren Khaw Â· Independent creative project</small>
      </footer>
    </main>
  );
}
